...
- *"Flag any emails that need follow-up by Friday"*

The agent reasons through a multi-step execution plan, interacts with the Gmail API, and completes the task.
